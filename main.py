...
class EventManager:
    ...
    def update_event(self):
        print(self.__event_ids)
        event_id = 0
        try:
            if len(self.__event_ids) > 0:
                ...
                print("Report is yet to be entered into NDP")
        except Exception as e:
            print(f"Error updating Report: {event_id} {e}")

    def upload_new_event(self):
        if len(self.__event_ids) == 0:
            print("Preparing to upload Reports")
